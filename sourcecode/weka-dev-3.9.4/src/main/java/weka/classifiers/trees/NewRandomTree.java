 ...
 */
public class NewRandomTree extends AbstractClassifier implements OptionHandler,
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        if (data.classAttribute().isNumeric()) { //tu nie wchodzi
            trainVariance =
                    NewRandomTree.singleVariance(classProbs[0], totalSumSquared, totalWeight)
                            / totalWeight;
    ...
    public String toString() {
        ...
        if (m_Tree == null) {
            return "NewRandomTree: no model has been built yet.";
        } else {
            return "\nNewRandomTree\n==========\n"
                    + m_Tree.toString(0)
                    + "\n"
    ...
    public String graph() throws Exception {
        ...
        if (m_Tree == null) {
            throw new Exception("NewRandomTree: No model built yet.");
        }
        StringBuffer resultBuff = new StringBuffer();
        m_Tree.toGraph(resultBuff, 0, null);
        String result =
                "digraph NewRandomTree {\n" + "edge [style=bold]\n" + resultBuff.toString()
                        + "\n}\n";
        return result;
    }
    ...
    protected class Tree implements Serializable {
        ...
        protected String toString(int level) {
            ...
            try {
                ...
                e.printStackTrace();
                return "NewRandomTree: tree can't be printed";
            }
        }
        ...
        protected void backfitData(Instances data, double[] classProbs,
            ...
            if (data.classAttribute().isNumeric()) { // tu nie wejdzie bo klasa nie jest numeryczna
                ...
                priorVar =
                        NewRandomTree.singleVariance(totalSum, totalSumSquared,
                                totalSumOfWeights);
            }
            ...
            if (attribute.isNominal()) {
                ...
                for (int i = 0; i < indexOfFirstMissingValue; i++) {
                    ...
                    if (inst.value(att) > currSplit) {
                        currVal =
                                NewRandomTree.variance(currSums, currSumSquared, currSumOfWeights);
                        if (currVal < bestVal) {
                            bestVal = currVal;
    ...
    public static void main(String[] argv) {
        runClassifier(new NewRandomTree(), argv);
    }
}
